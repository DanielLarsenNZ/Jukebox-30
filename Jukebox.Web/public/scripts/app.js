    var app = angular.module('jukebox', ['ngRoute']);
    
    // routes    
    app.config(['$routeProvider', function ($routeProvider) {
        $routeProvider
            .when('/', {
                templateUrl: 'views/jukeboxes.html',
                controller: 'indexController'
        })
            .when('/jukebox/:jukeboxId', {
    ...
    app.filter('timeDistance', function () {
        // https://github.com/B-Sides/angular-timedistance
